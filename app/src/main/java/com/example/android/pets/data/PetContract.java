...
public final class PetContract {
     ...
     * relationship between domain name and its website. A convenient string to use for the content
     ...
     * For instance, content://com.example.android.pets/pets/ is a valid path for looking for pet
     * data. content://com.example.android.pets/staff/ will fail, as the ContentProvider hasn't
     * been given any information on what to do with the "staff".
     */
